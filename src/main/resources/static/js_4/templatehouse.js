...
(function () {
  ...
  checksetElements.forEach((checksetElement) => {
    ...
    if (checksetText && checkboxInput) {
      const checksetClickHandler = () => {
        if (!checkboxInput.disabled) {
          checkboxInput.checked = !checkboxInput.checked;
        }
      };

      checksetText.removeEventListener("click", checksetClickHandler);
      checksetText.addEventListener("click", checksetClickHandler);
    }
  });
  ...
  radiosetElements.forEach((radiosetElement) => {
    ...
    if (radiosetText && radioboxInput) {
      const radiosetClickHandler = () => {
        if (!radioboxInput.disabled) {
          radioboxInput.checked = !radioboxInput.checked;
        }
      };
      radiosetText.removeEventListener("click", radiosetClickHandler);
      radiosetText.addEventListener("click", radiosetClickHandler);
    }
  });
